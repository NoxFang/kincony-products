# B4M Arduino Example 02 Read Digital Input Ports State
...
## File Structure
- `src/B4M_02_read_digital_inputs.ino` Arduino source code. Intended for developers who want to compile or modify the code themselves.
- `precompiled/B4M_02_read_digital_inputs.bin` Precompiled firmware binary for ESP32-S3. Suitable for users who want to quickly test the functionality without setting up a development environment.
