 ...
 * - The first line is "B4M Controller" in a larger font.
...
void page1() {
  // Set font size 18 for the larger "B4M Controller" text
  ...
  u8g2.print("B4M Controller");              // Display the text "B4M Controller" on the screen
