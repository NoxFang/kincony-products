# B4 Arduino Example 10: Print Text on SSD1306 OLED Display
...
## File Structure
- `src/B4_10_oled_ssd1306.ino` – Arduino source code for customization and compilation.
- `precompiled/B4_10_oled_ssd1306.bin` – Precompiled firmware binary for ESP32-S3, ready for direct flashing.
...
3. **Steps**:
   - Open `src/B4_10_oled_ssd1306.ino` in Arduino IDE.
...
## Important Notes
- **I2C Pins**: The code uses software I2C with **SCL = GPIO18, SDA = GPIO8**, matching the B4 pin definition.
...
## References
- For detailed pinout information, see the [B4 pin definition](../../../pin_definitions/B4_pin_definition.md).
