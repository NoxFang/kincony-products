# B4 Arduino Example 07: How to Use DS3231 RTC Clock

## Description
This example demonstrates how to use the DS3231 Real-Time Clock (RTC) module on the B4 board. It shows how to:
- Initialize the DS3231 over I2C.
- Read the current date and time.
- Set the RTC time via serial commands.

## File Structure
- `src/B4_07_ds3231_rtc.ino` – Arduino source code for customization and compilation.
- `precompiled/B4_07_ds3231_rtc.bin` – Precompiled firmware binary for ESP32-S3, ready for direct flashing.
...
3. **Steps**:
   - Open `src/B4_07_ds3231_rtc.ino` in Arduino IDE.
